/**
 * Login Form — PocketBase email/password auth.
 */
    ...
    >
      <div className="bg-white border border-slate-200 shadow-sm p-8">
        ...
        <form onSubmit={handleSubmit} noValidate>
          <div className="mb-5">
            <label htmlFor="login-email" className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">
              Email
            </label>
            <input
              id="login-email"
          ...
          <div className="mb-6">
            <label htmlFor="login-password" className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">
              Password
            </label>
            <input
              id="login-password"
